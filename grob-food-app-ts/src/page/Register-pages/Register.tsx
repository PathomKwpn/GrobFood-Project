...
import { DriverRegister, PartnerRegister, UserRegister } from "./components";
  ...
  return (
    <div className="w-full h-[auto]">
      ...
      <div className="flex flex-col justify-center items-center w-[100%] p-[10px]  h-[100vh] bg-[#01B14F]">
        <div className="flex flex-row w-[100%] justify-center md:gap-2 mt-[100px] md:mt-[70px]">
          <div
            className={
        ...
        {state === "partner" && <PartnerRegister />}
        {state === "driver" && <DriverRegister />}
      </div>
    </div>
  );
};
