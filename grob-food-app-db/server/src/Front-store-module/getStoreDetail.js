...
const exec = async (req, res) => {
  ...
  try {
    ...
    let sql_to_getStoreDetail = `select r.restaurant_id,r.score,restaurant_name,r.latitude,r.longitude,ri.restaurants_image_url ,restaurant_catagory ,close_time ,open_time,rt.restaurant_topic_name ,mi.menu_image_url ,m.menu_name ,m.price,m.menu_id from restaurants r 
